...
# create a multiselet for articles
...
if not selected_articles:
    ...
    col1.metric("total_sales", f'{total_filtered_sales:,}')
...
# show number of articles base on the filter
if not selected_articles:
...
article_grp = article_grp.sort_values(ascending=False)
